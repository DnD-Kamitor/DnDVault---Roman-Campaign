...
dg_map() {
  ...
  local url="https://dicegrimorium.com/files/${name}Public.zip"
  local out="$DG_DIR/${name}Public.zip"
  local dest="$DG_DIR/$name"
...
echo "-- Underground / Vault (Chapter 1) --"
...
dg_map "forest-path-vol-2-dnd-battle-map"
dg_map "forest-path-vol-3-dnd-battle-map"
dg_map "forest-path-vol-4-dnd-battle-map"
dg_map "forest-path-vol-5-dnd-battle-map"
dg_map "forest-wilderness-vol-2-dnd-battle-map"
dg_map "forest-wilderness-vol-3-dnd-battle-map"
...
dg_map "forest-barbican-gate-dnd-battle-map"
dg_map "forest-cave-entrance-dnd-battle-map"
dg_map "forest-ruins-dnd-battle-map"
dg_map "forest-labyrinth-ruins-dnd-battle-map"
dg_map "high-ground-forest-dnd-battle-map"
dg_map "swamp-dnd-battle-map"
dg_map "swamp-vol-2-dnd-battle-map"
dg_map "swamp-forest-vol-3-dnd-battle-map"
...
dg_map "river-crossing-vol-3-dnd-battle-map"
...
dg_map "road-altar-dnd-battle-map"
dg_map "island-ruins-dnd-battle-map"

echo ""
echo "-- Fort / Settlement / Roads (Vindolanda) --"
