...
*Part I covers the Roman world and your place in it. Read this before your first session. It gives you the history, the rules for character creation in this setting, and the cultural context you need to make meaningful choices.*
...
### Your Unit: The *Vexillatio Extraordinaria*

You are not part of a standard *contubernium*. Fort life runs on the eight-man tent unit; your group is something different.

Legate Corvinus assembled you individually, one at a time, for different stated reasons. The summons letters were brief. When you arrive at the anteroom outside his office, you find the others waiting. Some faces you recognize; some you do not. Corvinus comes out, closes the door behind him, and tells you something that the paperwork will not say.

This unit is a *vexillatio extraordinaria*: a special detachment pulled together outside the normal assignment process. Each person was selected for a specific function, not for their willingness to be grouped together. The official designation for your assignment is construction oversight. You will learn quickly what that means in practice.

Each character holds a formal military or religious role: a position with defined duties, specific pay, and access the rest of the fort does not have. Before Session 1, select a role from the *Unit Roles* chapter. Prerequisites are listed. No two characters hold the same role.

One position in the unit is not a standard Roman appointment. The *foederatus* (allied warrior) is a non-citizen treaty fighter bound to the unit by a personal combat charter signed by Corvinus rather than by enrollment in the Roman military system. Rome has used allied barbarian warriors this way since before the Republic: they are not legionaries, Rome does not pretend otherwise, and the arrangement works because both sides know exactly what the other is getting. A *foederatus* brings their own weapons, fights in their own style, and earns commendationes the same as anyone else in the unit. The path to citizenship is open to them, but it is a choice, not an expectation.

The unit has no formal name. A *vexillatio extraordinaria* is a designation, not an identity. Whether this group becomes something with a name is a question Session 1 leaves open. The DM will not script this moment; if it happens, it happens because someone at the table decides to make it happen.

The roles that no player character holds are filled by named NPC colleagues who will work, eat, and serve alongside you throughout the campaign. When those colleagues are killed or transferred, you feel the absence in specific mechanical ways and in the texture of daily life.

### Fitting the Setting

The campaign works best with characters who have a reason to be at Fort Vindolanda and a stake in what happens there. A role gives you that reason before you finish building the character.
...
For who your character *is* in cultural terms, which people they come from, what legal standing they hold, and which province shaped their assumptions before they ever arrived at the fort, see the Peoples of the Empire chapter. That chapter covers D&D races as Roman world cultures, provincial origins with free starting languages, and legal status across the five Roman classifications.
...
### Starting Level and Character Advancement

**Characters begin at Level 3.**

This is not an origin story. The campaign begins with soldiers who have already survived something. Each character has served at least one prior posting, survived at least one campaign, and arrived at Vindolanda with skills that were earned rather than issued. Level 3 reflects this: your class features are developed, your subclass is chosen, and your combat style is not something you are still figuring out. A Level 3 Fighter has trained into a specific discipline. A Level 3 Cleric has established a real relationship with a specific deity. A Level 3 Rogue has a particular set of tricks that the army has found reasons to tolerate.

**Subclass choice matters here.** At Level 3, the subclass is not just a mechanical option: it describes what kind of soldier you became. A Battlemaster Fighter and a Champion Fighter have both been in the same legionary training system and arrived at different places. Which path your character took shapes which role in the unit fits them best and what the legion saw in them when they assembled this particular unit.


**Advancement is milestone-based, not XP-based.**

The campaign does not count experience points. Characters advance when the session's central crisis resolves, not when a certain number of enemies fall. This is intentional: Roman military service is assessed by assignment completion, not by individual accumulation. A soldier who avoids every fight but ensures the mission succeeds has served better than one who fought constantly and failed the objective. The campaign rewards both approaches and does not distinguish between them mechanically at advancement.

All characters in the unit advance together. No character falls behind because they found a non-violent solution. No character races ahead because they fought more. The unit levels as a unit.

**The advancement arc:**

| End of session | Level reached | What it represents |
|---|---|---|
| Character creation | **3** | Established soldiers with history and subclass |
| Session 1 | **4** | The unit has faced something real and chosen how to handle it. The first ability score improvement or feat for most classes. The gods are real, the spear is real, and the party has made a choice it cannot take back. |
| Session 2 | **5** | Multiattack for Fighters and Rangers. Third-level spells for full casters. The unit has survived the Tribune's interference and proved it can operate without Rome's blessing. It is no longer following orders: it has its own judgment now. |
| Session 3 | **6** | The forest and the grove. The campaign's divine stakes have moved from rumor to personal experience. Subclass improvements for many classes at this level. The party is no longer soldiers caught in an unusual situation: they are the situation. |
| Session 4 | **7** | The procession below, the antechamber, Mars' demand. The unit has descended into something older than Rome and come back. Level 7 is the campaign's final level: characters carry this through Session 5 without further advancement. The story resolves at this power level. |

**Level 7 is the ceiling.** This campaign is not designed for higher levels. The encounters, the divine confrontations, and the corruption system are all calibrated for the Level 3-to-7 arc. Characters who reach Level 7 in Session 4 carry that level into Session 5 and the final confrontation with full resources.


**Recovery between sessions.**

Between sessions, assume a full week of fort life: sleep, food, routine duty, downtime activities. Characters begin each session with all hit points restored, all spell slots recovered, and all limited-use class features recharged. Short rest and long rest resources both reset between sessions.

Within a session, resources are tracked normally: spell slots, superiority dice, ki points, and hit points do not automatically recharge between scenes. Plan accordingly. The procession below in Session 4 is a multi-encounter sequence with no opportunity for a long rest. The party that goes in at full resources is a different party from the one that limped through Session 3 without sleeping.


**A note on role and level.**

The unit role you hold is separate from your character level. Both advance, but on different tracks and for different reasons. Your character level tracks your personal growth as an adventurer. Your role rank tracks your institutional standing in the legion: what the army has officially recognized, what access you have, what Varro will authorize, and what the other soldiers at the fort know to call you. A character can be Level 6 and still hold a junior rank in their role if they have not performed the specific acts that earn promotion. They can also hold a senior rank at Level 4 if they have done exactly what the role required at exactly the right moment. Level and role rank are not coupled. Both matter. For role progression, see the Unit Roles chapter.
...
All 18 PHB skills are available in this campaign. Each one has a Roman-world context that makes some rolls matter more, some checks reveal different things, and some situations reward two characters combining different skills together for results neither could reach alone.

Your cultural origin (which D&D race you play) also gives you starting skill bonuses that stack with your proficiency bonus and ability modifier: flat bonuses that represent what your background has already given you before the campaign starts. A Greek-origin character walks into Session 1 with Arcana and History fluency baked in. A Germanic *foederatus* walks in with Athletics, Survival, and Nature already elevated.

For full Roman skill context, skill combinations, starting bonuses by cultural origin, and how skills chain into relationships and outcomes, see the Skills chapter.
...
The table above covers the standard kit. The campaign includes a wider range of Roman weapons with expanded D&D 5e mechanics: *pilum* variants, sling ammunition types (*glandes*, stone, clay incendiary), arrow subtypes (bodkin, broadhead, fire), the *plumbata* dart, and the *dolabra* pick with structure-damage rules. For full stats, tactical notes, and the Vindolanda supply table, see the Roman Weapons and Ammunition section in *Roman Tactics in D&D 5e*.
...
For province-of-origin language tables showing which languages each provincial background provides as a free starting language, and for how your race and province interact to shape your cultural identity, see the Peoples of the Empire chapter.
