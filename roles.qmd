...
**Mechanic:** You always know the current day's password and the complete patrol schedule. You can create a false password (DC 14 Charisma (Deception), detected on DC 15 Intelligence (Investigation) by anyone who has seen the real one). You know which posts are currently manned and by whom.
...
**Standard** (0 commendationes): Know the current day's password and full patrol schedule. Create a false password (DC 14 Charisma (Deception)). Know which posts are manned and by whom at all times.
...
**Mechanic:** Access to the unit savings fund (currently 100 gp at campaign start). Drawing on the fund requires DC 14 Charisma (Persuasion) (a majority of the unit votes to authorize it) or DC 18 Charisma (Deception) (forging the ledger, detected on DC 16 Intelligence (Investigation) by anyone who checks). The fund grows when the party completes supply missions or recovers assets.
...
**Standard** (0 commendationes): Access to the unit savings fund (100 gp at campaign start). Authorize withdrawals via DC 14 Charisma (Persuasion) or detect forgery via DC 16 Intelligence (Investigation).
...
**Standard** (0 commendationes): As a bonus action, signal a formation change for all allies within 60 feet. Once per session, sound a false retreat (DC 15 Charisma (Performance) vs. enemy Insight).
...
**Mechanic:** You can stabilize a dying creature using Medicine (no action cost, just DC 10 Wisdom (Medicine)). Once per day, spend 10 minutes and a healer's kit use to heal 2d6 + WIS modifier HP. You can identify poison, disease, or unusual wound cause with DC 13 Wisdom (Medicine) and no additional resources.
...
**Standard** (0 commendationes): Stabilize a dying creature with Medicine (no action cost, DC 10 Wisdom (Medicine)). Once per day, spend 10 minutes and a healer's kit use to heal 2d6 + Wisdom modifier HP. Identify poison, disease, or wound cause at DC 13 Wisdom (Medicine).
...
The Antonine Plague presents with fever, skin eruptions, and diarrhea in a specific sequence. Ordinary camp fever presents similarly but the sequence differs. You can distinguish them with DC 15 Wisdom (Medicine) and three days of observation. The plague is fatal in roughly one-third of cases in civilian populations and somewhat lower in military ones, possibly due to better nutrition.
...
**Mechanic:** Craft or repair mundane weapons and armor at half cost with forge access. Assess structural weaknesses: DC 13 Intelligence (Investigation) reveals a weak point in a wall, door, or structure. Once per session, improvise a piece of equipment (battering ram, caltrop field, burning pitch container) from available materials with a DC 14 Smith's Tools or Mason's Tools check.
...
**Standard** (0 commendationes): Craft or repair mundane weapons and armor at half cost with forge access. Assess structural weaknesses at DC 13 Intelligence (Investigation). Once per session, improvise a piece of equipment from available materials (DC 14 Smith's or Mason's Tools).
...
**Mechanic:** Forge military documents (DC 14 Forgery, detected on DC 15 Intelligence (Investigation) by anyone who examines them). Access incoming dispatch copies as a matter of routine: you know what Rome officially knows about this fort, including what has and has not been reported. Produce legally binding Latin documents on request.
...
**Standard** (0 commendationes): Forge military documents (DC 14 Forgery, detected on DC 15 Intelligence (Investigation)). Routine access to incoming dispatch copies. Produce legally binding Latin documents on request.
...
**Standard** (0 commendationes): Move at full speed without penalty in forest or wilderness. Advantage on Perception in wilderness. Track creatures (DC 12 Wisdom (Survival)). Once per session, call on a border informant for local intelligence (1d4 hour wait).
...
**Mechanic:** Request information from the *frumentarii* network across the empire (DM provides after 1d4 days, encrypted courier round-trip). Use a coded communication system that cannot be traced to the unit by normal Investigation. Once per session, make a DC 13 Wisdom (Insight) check against any named NPC to determine whether they are filing independent reports to Rome outside the official dispatch system.
...
**Standard** (0 commendationes): Request information from the *frumentarii* network (1d4 day delay). Coded communication untraceable by normal Investigation. Once per session, DC 13 Wisdom (Insight) to detect NPCs filing independent reports to Rome.
...
|---|---|---|
| Optio | Orders require explanation; unit will not follow commands automatically without a DC 12 Charisma (Persuasion) check by whoever is leading | Morale saves at disadvantage for the entire unit |
