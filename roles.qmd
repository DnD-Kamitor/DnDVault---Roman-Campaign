...
- **Shield:** *Scutum* (+2 AC, 6 lb). Carried in deployment; stored when conducting briefings and administrative duties.
- **Arms:** Leather gauntlets (1 lb). Standard for any officer who handles written records and formation reports.
- **Cloak:** *Sagum* (4 lb).
- **Boots:** *Caligae* (2 lb).
- **Belt:** *Cingulum Militare* with decorative bronze fittings (2 lb). The quality of the fittings is the first visible indicator of the optio's rank; a soldier who looks carefully at the belt reads the role immediately.
...
**Weight total:** 49 lb. At CHA 13 or STR 14, carrying capacity is at least 195 lb; well within comfortable range.
...
- **Shield:** *Scutum* (+2 AC, 6 lb). Carried in alert conditions; left at the duty station during routine night checks. Moving through the fort's narrow internal passages with a large oval shield creates more problems than it solves.
...
- **Belt:** *Cingulum Militare* with wax tablet and stylus attached (2 lb + 1 lb). The tablet for recording watch irregularities is on-person at all times during duty hours.
...
**Weight total:** 43 lb. Light enough to move through the fort without generating sound that carries ahead.
...
**Weight total:** 40 lb. Carrying capacity at STR 15: 225 lb (half-capacity threshold: 112 lb). The strength prerequisite exists for holding the *aquila* aloft for hours under march conditions, not for managing the kit.
...
- **Cloak:** *Sagum* (4 lb).
- **Boots:** *Caligae* (2 lb).
- **Belt:** *Cingulum Militare* with banker's satchel (2 lb belt + 1 lb satchel). The satchel attaches to the belt's rear loops and carries the ledger, wax tablets, and stylus. It does not interfere with weapon access and does not occupy an equipment slot.
- **Weapon:** *Gladius* (1d6, 3 lb). Drawn right-handed; the *signum* occupies the left arm in formation.

**Weight total:** 40 lb. The role has no strength prerequisite; this kit falls well within the comfortable range for typical builds.
...
**Weight total:** 35 lb. The lightest standard kit in the unit. This is deliberate.
...
**Weight total:** 40 lb. Designed for a high-Wisdom character who is unlikely to have the highest Strength in the unit.
...
- **Belt:** *Cingulum Militare*, plain bronze fittings (2 lb) with priestly satchel: the *libri haruspicini* reference tablets, incense, and the small ritual case.
...
**Weight total:** 21 lb (ceremonial kit with *paludamentum*). The lightest non-Flamen kit in the unit.
...
- **Shield:** *Scutum* (+2 AC, 6 lb). Carried when deployed. In the *fabrica* itself, the shield is racked at the door: it would interfere with both hands being used at the forge.
...
- **Boots:** *Caligae* (2 lb).
- **Belt:** *Cingulum Militare* with tool loops (2 lb). A hammer and chisel hang from the tool loops during work; in combat, the tools are left at the site and the belt functions as standard military equipment.
...
**Weight total:** 52 lb. At STR 13, carrying capacity is 195 lb; well within comfortable range.
...
**Weight total:** 43 lb. Standard for an INT 14 character with typical Strength.
...
- **Belt:** *Cingulum Militare* (2 lb) with field pack: three days of rations, fire starter, spare bowstring, cord, and one smoke signal token. Total pack weight: 2 lb.
...
**Weight total:** 41 lb. At DEX 13 and typical Strength, well within comfortable carry for multi-day movement.
...
- **Shield:** *Scutum* (+2 AC, 6 lb). Carried on duty. When conducting intelligence work in civilian areas, the shield stays at the fort: a soldier carrying a full *scutum* while visiting the *vicus* is unusual and noticed.
...
**Weight total:** 41-42 lb depending on cloak selection. Unremarkable in both directions.
...
- **Belt:** *Cingulum Militare* (2 lb) with priestly kit attached: incense pouch, small bronze knife for sacrificial work, two small clay offering vessels.
...
**Weight total:** 39 lb (routine kit with *sagum*). The *paludamentum* replaces the *sagum* during ceremonies without changing the total weight.
...
**Weight total:** 20 lb. The frontier cult doctrine frames this deliberate lightness as a statement: the Flamen Martialis is protected by Mars, not by iron. Whether that is comforting depends on how well the campaign is going.
...
**Weight total:** 28 lb. The second-lightest combat-viable kit in the unit.
...
- **Shield:** *Scutum* (+2 AC, 6 lb). In exemplary condition. The custos armorum's shield is the visual demonstration of what a properly maintained *scutum* looks like.
...
**Weight total:** 46 lb. At STR 12, carrying capacity is 180 lb; well within comfortable range.
