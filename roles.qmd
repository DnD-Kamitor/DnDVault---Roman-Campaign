...
The Roman military has a phrase for what you do when you Rage. It is not a compliment and it is not an insult. It is a tactical classification used in the training manuals, and soldiers who have served on the Rhine frontier know it on sight.

*This tradition covers the forest and plains tribes of the Rhine interior and the northern reaches: Chatti, Chamavi, Cherusci, Suebi, and the Marcomanni. The Franks as a named confederation do not yet exist in 175 AD — the Rhine-delta peoples with the cavalry and river-crossing tradition are covered under the Batavian entry below.*

**Combat:** While Raging, you are immune to the frightened condition. When you enter Rage, each enemy within 30 feet that can see or hear you must succeed on a DC 12 Wisdom saving throw or lose the ability to take the Disengage action until the start of your next turn. The Disengage action is what lets a creature move away without triggering opportunity attacks — failing this save means they cannot retreat safely. Any movement they make away from you this turn provokes your opportunity attack. The surge holds them in place the way a hunting scream holds prey.

**Narrative:** Soldiers who have served on the Rhine recognize *furor teutonicus* immediately. Their response is specific: they move out of your path, not because of you personally, but because they know what they are looking at and they have been trained to respect its direction. Officers treat you with tactical respect. Common soldiers maintain personal distance until you have given them a reason to close it. You have advantage on Intimidation checks when your Germanic origin is known and relevant, and advantage on Survival checks to navigate or track in forest and river terrain.
...
**Narrative:** Gallic warriors occupy an uncomfortable middle position in the Roman frontier imagination: almost legible, never quite trusted, occasionally respected with the specific warmth reserved for capable enemies who eventually came around. Roman soldiers sometimes recognize the guard and the footwork from their own training without knowing where it originally came from. Officers who know their military history have considered opinions about Gallic *foederati*. You have advantage on History checks relating to Gaul, the northern Roman road network, and the supply infrastructure of Belgica and Lugdunensis. Gallic NPCs in civilian settlements treat their first interaction with you as one step more favorable than their base disposition.
...
**Combat:** When you take the Disengage action, you may make one melee weapon attack as part of the same action before or after moving — strike-and-fade is one sequence. When you enter Rage while not currently in combat (you entered willingly, not reactively), each enemy within 30 feet that can see or hear you must succeed on a DC 13 Wisdom saving throw or have disadvantage on their first attack roll this round. The war-scream is a recognized psychological instrument; it is not incidental. You cannot be surprised while in natural terrain (forest, hills, moorland, marsh).

**Narrative:** The soldiers at Vindolanda have heard about the Caledonians from veterans on the northern posts. The stories are specific: not about how hard they hit but about where they were not, and then were. Roman punitive expeditions — Agricola's campaigns, the brief Antonine advance — all ended the same way: Rome built things and eventually withdrew. You chose to come through the Wall. Every soldier who understands what that means treats the fact with specific seriousness. Those who do not understand it yet will catch up. You have advantage on Survival and Perception checks in highland and moorland terrain. The Selgovi, Votadini, and Novanti have distinct relationships with different Caledonian groups; the DM determines initial NPC attitude based on your specific tribal origin.
...
You are from a kingdom that no longer exists. Trajan's column in Rome shows the conquest in stone — the battles, the prisoners, the king's suicide on the last day. Your people are on that column. What survived the absorption is what you carry: the techniques, the weapons, and the particular weight of knowing exactly what the machine you are now inside did to the people you come from.

**Combat:** You are proficient with the falx (see roman_tactics.qmd). The falx bypasses the AC bonus provided by shields. When you hit a shielded creature with any two-handed weapon, they must succeed on a DC 12 Strength saving throw or their shield arm is driven wide — they lose the shield's AC bonus until the start of their next turn. This technique was so effective that Trajan mandated new armor after the first Dacian war. The soldiers you are fighting now are wearing the answer to your ancestors' weapon.

**Narrative:** The falx forced Rome to redesign its armor twice. Veterans who served in the Dacian campaigns know this and look at you with measuring respect: they are deciding whether the person in front of them is the same quality as the warriors who made that necessary. The honest ones will tell you this directly. A Dacian fighting inside the machine that broke Dacia is a complicated statement, and not everyone in the unit has the vocabulary for it. Some will ask about it. Most will not. You have advantage on History checks relating to the Dacian campaigns and the Danube frontier.
...
Marcus Aurelius sent 5,500 Sarmatian cavalry to Britain in 175 AD as part of the Iazyges peace settlement — you may be among the most recently arrived. You are being posted to the Wall in groups. You are not Roman, not Germanic, not British. The garrison at Vindolanda is still working out which category covers what you are.

**Combat:** Your formation training was built around receiving the charge and redirecting its momentum. When a creature moves at least 15 feet toward you on its turn before attacking you, you may use your reaction to brace: the attack's damage is halved and the attacker must succeed on a DC 13 Strength saving throw or be pushed 5 feet away and stopped. While you have not moved this turn, attacks you make with reach weapons or two-handed weapons deal +1d6 damage — the stationary stance is a platform, and you know how to use it.

**Narrative:** Roman soldiers know Sarmatian heavy cavalry from soldiers who served on the Danube: scale armor like a fish, the *draco* battle-standard that screams in wind during a charge, steppe tactics unlike anything in the Roman training manuals. Most of the Vindolanda garrison has not seen one in person before you arrived. Officers who served on the Danube frontier treat their first interaction with you as frank professional respect — they know what Sarmatian cavalry can do and they are deciding whether you personally are that quality. Everyone else is curious in the way soldiers are curious about things that might kill them. You have advantage on Animal Handling checks with horses and on Survival checks in open grassland or steppe terrain.
...
Your people have been Rome's most capable auxiliary cavalry for over a century. The river-crossing techniques, the swimming in full armor, the combat dismount — these are not things Batavians learned from Rome. Rome learned them from Batavians and then recruited the people who knew them.

**Combat:** You move through water at full speed without Athletics checks or movement penalty, regardless of depth or current. When you move through water before attacking on your turn, the attack deals +1d6 damage — you break from a medium the enemy did not expect anyone to cross cleanly. You are proficient in Athletics if you are not already; if you already have proficiency in Athletics, you add double your proficiency bonus to Athletics checks involving swimming, climbing, or crossing difficult terrain.

**Narrative:** The Batavian revolt — when your people briefly broke from Rome under Civilis in 69 AD — is officially a closed matter. In practice, Roman officers keep it somewhere in their assessment alongside every other story of a capable ally who chose their own direction once. The professional relationship remains genuine and well-established. Batavian auxiliaries have served on the British frontier long enough that soldiers at Vindolanda either served with them or know soldiers who did. First interactions from veterans who served alongside Batavian units are warm familiarity rather than assessment. You have advantage on History checks relating to Rhine frontier campaigns and river-crossing operations, and on Survival checks to assess or navigate any body of water.
...
Choose a fighting style. The style is permanent once chosen and reflects the identity you built in the arena.

**Murmillo** *(heavy, shield-forward, shield-breaker)*: You gain proficiency with the *scutum* if you do not have it, and you can treat the *scutum* as a light object for the purposes of shield bash. When fighting with a one-handed weapon and shield, once per turn you may add 1d4 bludgeoning damage to a hit as a free shield bash (no bonus action cost).

**Thraex** *(mobile, curved blade, reading the opponent)*: Requires DEX 13. When you move at least 10 feet before making a melee attack this turn, that attack deals +1d6 slashing damage. Enemies do not gain opportunity attacks against you when you disengage as a bonus action — you learned the exits and you use them on your terms.

**Dimachaerus** *(two weapons, no shield, maximum attack rate)*: When fighting with two weapons, you may add your Strength or Dexterity modifier to your off-hand attack's damage roll (removing the standard penalty that prevents this). Additionally, once per turn when you land a hit with your main-hand weapon, you may make your off-hand attack without spending your bonus action. Your bonus action is free for other uses that turn.

**Retiarius** *(net-and-trident, lightest armor, control fighter)*: Requires DEX 13. The *retiarius* fights almost naked by arena standards: you may not wear heavy armor while this style is active — medium armor maximum. When you throw the *rete* (net), you may make one additional weapon attack as part of the same attack action. Your attacks deal +1d6 piercing damage against restrained targets. When a restrained creature attempts to escape, you may use your reaction to make one melee attack against them.

**Secutor** *(pursuit fighter, net-counter, relentless pressure)*: The *secutor* was built as the direct counter to the *retiarius* — smooth helmet that a net cannot snag, large shield, relentless forward movement. You cannot be restrained by mundane nets or entangling effects (smooth equipment, practiced shrug). When a creature moves away from you, you may use your reaction to move up to your speed toward them; this movement does not provoke opportunity attacks. When you move at least 10 feet toward a creature and then hit it, that attack deals +1d4 damage.

**Hoplomachus** *(spear and buckler, reach control, counter-charge)*: Requires a reach weapon in your main hand. When wielding a reach weapon, you may make one opportunity attack when a creature *enters* your reach as well as when they leave it (standard rules). On a hit with your reach weapon, the target must succeed on a DC 12 Strength saving throw or be pushed 5 feet away from you. Once per turn, if you have not moved this turn, you may brace: the next creature that enters your reach makes that saving throw at disadvantage.

**Provocator** *(heavy armor, challenger, absorber)*: The *provocator* was the heaviest-armored gladiator and the one most visibly designed to invite punishment and survive it. When wearing medium or heavy armor with a shield equipped, your AC improves by 1 (the full coverage leaves no obvious gap). When a creature attacks you and misses, you may use your reaction to make one melee attack against them. At the start of each of your turns while Raging, you gain temporary hit points equal to your Constitution modifier.
...
Choose a warrior tradition at this tier. The tradition is not the same as your regional origin — it is the combat philosophy you built from that origin. A Germanic warrior might take the Endurance path; a Gallic warrior might take the Shield-Breaker path. Origin shapes where you started; tradition shapes what you built.

**The Shield-Breaker** *(heavy assault, gap-closer, line-cracker)*: Your weapon opens the way before the line sets. When you make your first melee attack on your turn against a creature carrying a shield, you ignore the shield's AC bonus on that attack. On a hit, the target must succeed on a DC 13 Strength saving throw or their shield arm is driven wide — they lose the shield's AC bonus until the start of their next turn. Once per turn when you hit a creature with a melee weapon, you may immediately push them up to 10 feet in any direction; this movement does not trigger opportunity attacks from your allies.

**The Reiver** *(hit-and-run, terrain exploitation, first-blood specialist)*: You hit hard and you are somewhere else before the counterattack arrives. When you move at least 20 feet before attacking on your turn, the attack deals +1d8 damage and you do not provoke opportunity attacks from that target until the start of your next turn. Once per turn, even while Raging, you may take the Hide action as a bonus action while in natural terrain (forest, marsh, hills, rocky ground).

**The Shock-Charger** *(straight assault, fear, forward momentum)*: You open engagements and the unit rides the wake. When you move toward a creature in a straight line of at least 15 feet and attack them on the same turn, the attack deals +1d10 damage and the target must succeed on a DC 14 Strength saving throw or be knocked prone. Once per turn when you drop a creature to 0 hit points while Raging, you may immediately move up to half your speed toward another creature as a free action; this movement does not provoke opportunity attacks.

**The Endurance Fighter** *(absorb and outlast, Pannonian tradition)*: You were trained to be the last one standing, not the first one to score. While Raging, at the start of each of your turns you gain temporary hit points equal to your Constitution modifier + your proficiency bonus (each turn's total replaces the last rather than stacking). Once per long rest, when you are reduced to 0 hit points while Raging, you may make a DC 15 Constitution saving throw; on a success, you drop to 1 hit point instead and your Rage does not end.

**The Falx-Master** *(overhead assault, anti-armor, guard-breaking)*: The falx was designed to pull shields down and cut through from above. You are proficient with the falx if you are not already. When you hit a creature with a two-handed weapon, they must succeed on a DC 13 Strength saving throw or have disadvantage on attack rolls until the start of your next turn — their guard has been broken and they know it. Once per turn when you score a critical hit with a two-handed weapon, you may immediately make one additional attack as part of the same action.
