...
- **Arms:** Nothing issued. You bring your own.
...
<details>
<summary><strong>Branch B: *Pugil Extraordinarius* — Unit champion</strong></summary>


**Perk 1: *Murus Carnis* ("Wall of Flesh")** — When an ally within 5 feet would be reduced to 0 hit points by a melee attack, you may use your reaction to step into the blow. The damage is redirected to you. If you are currently Raging, the redirected damage costs at most half your remaining hit points — the rage absorbs what would otherwise kill you. This ability cannot be used if you are incapacitated.

**Specialis** (7 commendationes):


**Perk 2: *Caput Exercitus* ("Head of the Army")** — *(locked: STR 18 required)*
While you are conscious and visible to allies: they automatically succeed on morale saves against fear effects of CR 5 or lower. Once per long rest, when the unit fails a morale check or would rout, your presence reverses the outcome — no roll required. Allies who have seen you save them remember it; social interactions with those allies treat you as two ranks higher for the duration of the campaign.
*Locked to STR 18: this authority is physical. It comes from what soldiers have watched you survive, not from anything you said.*
