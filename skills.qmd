...
DC 17 and above produces what the campaign calls dangerous knowledge: the specific facts that change what the party can do, not just what they understand. The three cross-reference unlocks below are the most important:

**Military DC 17 unlocks a ruins check:** A character who reaches DC 17 on Roman Military Lore (the specific content is in `knowledge.qmd`) gains a +4 bonus to Investigation checks in the ruins beneath the fort. They know what Roman and pre-Roman military sites were built to contain, and they are looking for the right things.

**Germanic Tribes DC 15 unlocks a Vercingetorix approach:** A character who reaches DC 15 on Germanic Tribes can approach Vercingetorix using the correct social form for a request to a man of his status. This skips the first tier of his relationship structure and begins the conversation at Acquaintance rather than Stranger.

**Divine Signs DC 17 unlocks a Session 4 augury:** A character who reaches DC 17 on Reading Divine Signs (in `knowledge.qmd`) can perform the correct augury form when the ravens behave unusually before the Chapter 4 siege opening. The augury's result is not random; it reveals a specific piece of information about the siege's first critical moment that the party can act on before it arrives.
