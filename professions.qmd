...
**Campaign hooks:** The *haruspex* is one of the first to notice when divine attention is being paid to specific people or places. Abnormal augury results can provide early warning of events that have not yet reached anyone else's awareness. A *haruspex* in the party becomes a living sensor for changes in divine attention across the campaign.
...
**Campaign hooks:** Administrative irregularities leave traces in the paperwork even when those responsible are careful: mismatched records, supply discrepancies, payments that should not exist. A *librarius* who knows what to look for can find evidence in records that others would never think to examine. Investigation DC 14 applied to the right archive often yields more than the original investigation expected.
...
**Campaign hooks:** Siege equipment that must hold, fortifications under pressure, and unusual artifacts requiring technical assessment all have a dimension that only a skilled smith can evaluate. When something has been made wrong on purpose or maintained wrong on purpose, a *faber* is often the only person who can prove it.
...
**Campaign hooks:** The trading networks that feed the Germanic frontier also carry information and sometimes people. A *mercator* in the party is positioned to notice unusual patterns: goods moving the wrong direction, people traveling under cover of trade, money flowing where it should not. The frontier economy is a significant intelligence resource if someone knows how to read it.
...
**Campaign hooks:** Former gladiators occupy an unusual social position: recognizable in ways other soldiers are not, connected to patronage networks that cross all social classes, and trained in a specific style of violence that differs significantly from military combat. These connections and that expertise will both prove relevant before the campaign ends.
...
**Campaign hooks:** The temples of Rome carry significant intelligence: priests hear confessions, witness vows, and receive petitioners from every social class. A *sacerdos* has natural access to senior priests who otherwise require significant social navigation, and to the information those priests gather in the course of their duties. Augur Cassia is more accessible to another religious practitioner than to a soldier presenting without context.
...
**Campaign hooks:** The forest ahead of the frontier, the Roman intelligence network, and the Germanic contacts the party will need to work with all involve information that an *explorator* can access through professional channels that other party members cannot. An *explorator* is often the reason the party knows something before it becomes a crisis.
...
Unofficial religious associations organized around specific deities exist throughout Roman society. They occupy legal grey areas: private worship is not automatically illegal, but an organization becomes illegal through what it does rather than what it formally is. When such organizations acquire significant resources and begin acting politically, the distinction between a *collegium* and a conspiracy becomes a matter of who is prosecuting whom.
