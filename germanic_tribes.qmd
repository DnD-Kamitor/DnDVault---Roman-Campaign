...
## Peoples Near the Vallum

Vindolanda sits in Brigantes territory. The tribes beyond the Wall are not an undifferentiated mass of barbarians; each has its own political relationship with Rome, its own skills, and its own reason to trade with or kill the party.

### The Brigantes

The dominant tribe of northern Britannia. Their territory runs from roughly the River Humber north to Hadrian's Wall and beyond. Their patron goddess is Brigantia, equated with Minerva: patron of smithing, craftsmanship, and righteous combat. Brigantes blacksmiths are known throughout the Province for quality work.

The Brigantes have a complicated history with Rome: they were allied under Queen Cartimandua, then rebelled under her husband Venutius. Queen Cartimandua's bloodline persists; some of her descendants are now Roman equestrians and senators. Some locals are fiercely proud of this heritage. Others resent it as proof that their people were bought.

### The Selgovi

Occupy most of the region just north of Hadrian's Wall. Organized as a tribal confederation with a high king recognized by all sub-kings. They hate the Vallum because it cut their traditional lands.

The Selgovi are exceptional informants and guides; they know every path, ford, and hidden camp north of the Wall. However, they are skilled political operators who balance alliances based on current advantage. A Selgovi guide who leads you safely through the hills today may have sold your route to someone else tomorrow. Parties hiring Selgovi help should negotiate carefully and assume information flows both ways.

### The Votadini

Hold the east coast between Hadrian's Wall and the old Antonine Wall. Practical rather than warm: they are a buffer state that has maintained a wary relationship with Rome for generations because it is profitable. Their old stronghold was the hill fort at Traprain; their kings have recently moved to a new settlement called Din Eidyn further north.

The Votadini will provide guides, food, and horses in exchange for coin or Roman manufactured goods. They will not betray Rome openly while Roman coin is flowing. They will also not risk themselves for Roman interests when it costs them.

### The Novanti

West of the Selgovi, "the Mighty." Intensely isolationist; they live in *crannogs*, fortified dwellings built on artificial islands in lakes and ponds. A crannog can house a single family or an entire clan (some are over 100 feet in diameter). Access is only by boat or via hidden submerged walkways.

The Novanti have largely ignored Rome since the frontier stabilized. Rome has largely ignored them back. This means no one knows their current alliances, grudges, or intentions. Parties who must travel through Novanti territory should treat every lake and pond as potentially inhabited, and every inhabited crannog as potentially hostile.
...
Four Germanic war goddesses with an official shrine inside the temple of Mars at Vercovicium, a fort on Hadrian's Wall. Their collective name means "Dispatching Terrors" or "All Victorious." Roman scholars compare them to the *Valchyriae* (Valkyries) of the northern Germanic tribes, war goddesses who choose the slain and punish oath-breakers.

Their four names and domains:

| Name | Title | Symbol |
|------|-------|---------|
| Baudihilla | "Lady of Battle" — the most aggressive, leads followers into combat | Sword with winged hilt |
| Beda (or Ricagambeda) | "The Warden" — protects those who fight for the weak | Shield carved with a raven |
| Fimmilena | "The Avenger" — punishes oath-breakers | Whip |
| Friagabis | "The Liberator" — protects those who fight against oppression | Short dagger (cuts bonds) |

The Pontifices have not admitted the Alaisiagae to the official cult, but the local priests of Mars at Vercovicium tolerate their shrine because denying soldiers their protective goddesses on the frontier would cause worse problems than the shrine itself creates.

**The raven sign.** Both the Britanni and the Germanic soldiers along the Wall treat raven apparitions as omens of death. The Alaisiagae are said to appear in the form of ravens when invoked. A raven landing near a sick soldier, or a raven that follows a patrol, is read as a message, though whether the message is "death comes for one of you" or "the Warden watches over you" depends on which name you prayed to last.

<details>
<summary><strong>DM: Using the Alaisiagae against Mars</strong></summary>

The Alaisiagae can serve as a dark mirror to the party's relationship with Mars. Where the cult of Mars demands sacrifice and control, the Alaisiagae demand loyalty and justice. A Germanic soldier PC may invoke them instead of Mars, with different consequences.
...
<details>
<summary><strong>GM: Agrona — The Growing Threat</strong></summary>

Agrona is a goddess of war and massacre originating among the Caledoni north of the Antonine Wall. Her cult demands human sacrifice, preferably of war prisoners; the tribes that honor her typically plunge into battle seeking new ritual victims.

She would have remained a distant threat had Rome not abandoned the Antonine Wall. Her followers interpreted that withdrawal as her victory over Rome. Since then, her cult has moved steadily south. Today, her followers are believed to be behind every major insurrection north of Hadrian's Wall.

Her symbol is the ritual killing: throat-cut bodies found near the Wall, the blood drained into the earth as an offering. Distinguish her kills from Taranis (drowning/water sacrifice) and from simple raider violence (bodies looted, left where they fell).

**For the campaign:** Agrona's expanding influence explains why violence near the Wall seems coordinated even when the tribes involved are traditional enemies. She is not directly present in the campaign's five sessions, but her shadow is useful for chapter 3 wilderness encounters and chapter 4 siege motivation. Any NPC warrior who fights with abandon and ignores wounds may be a devotee.
...
The twenty-four runes of the Elder Futhark, with their D&D game significance, grouped into
the three traditional *aettir* (families of eight). This grouping is the reference to use
for any new prop that needs a rune carved on it — Thusnelda's map, the Session 1 vault
tokens, Lucius's lockbox, or anything still to come.

Every player at the table can safely read the rune, its name, and its meaning below — that
part is open lore, the kind any character raised near the frontier might know. What a
specific carving actually *does* in game terms is DM-facing information and stays behind
the toggle beneath each table; do not read those effects aloud until a character has
reason to know them.
...
| # | Rune | Name | Meaning |
|---|---|---|---|
| 1 | <span class="rune-glyph">ᚠ</span> | Fehu | Cattle, wealth, mobile property |
| 2 | <span class="rune-glyph">ᚢ</span> | Uruz | Aurochs, strength, raw force |
| 3 | <span class="rune-glyph">ᚦ</span> | Thurisaz | Giant, thorn, directed force |
| 4 | <span class="rune-glyph">ᚨ</span> | Ansuz | Aesir, breath, divine communication |
| 5 | <span class="rune-glyph">ᚱ</span> | Raidho | Ride, journey, the right path |
| 6 | <span class="rune-glyph">ᚲ</span> | Kenaz | Torch, opening, knowledge |
| 7 | <span class="rune-glyph">ᚷ</span> | Gebo | Gift, exchange, balance |
| 8 | <span class="rune-glyph">ᚹ</span> | Wunjo | Joy, harmony, wish |

<details>
<summary><strong>DC 15 Intelligence (Arcana) — Recalling what each of Freyr's Aett does when carved</strong></summary>

- **Fehu:** Carved on a coin purse or trade goods: +2 to Persuasion checks involving commerce for the session.
- **Uruz:** Carved on a weapon: the weapon deals +2 damage on the first hit each combat.
- **Thurisaz:** Carved on a gate or barrier: creatures attempting to force it through must make a DC 14 Strength check.
- **Ansuz:** Carved on a message or object: the intended recipient recognizes it as meant for them across any distance; they sense the sender's identity.
- **Raidho:** Carved on a wagon or boot: travel by this route takes half the expected time once per journey.
- **Kenaz:** Carved on a door or seal: the carver knows if the sealed item has been opened or disturbed.
- **Gebo:** Carved on two objects of equal value: the exchange is witnessed by the gods; breaking the agreement incurs divine displeasure (-1d4 to all rolls for 24 hours).
- **Wunjo:** Carved on a dwelling or camp: creatures sleeping here recover one additional HD during a long rest.
...
| # | Rune | Name | Meaning |
|---|---|---|---|
| 9 | <span class="rune-glyph">ᚺ</span> | Hagalaz | Hail, disruption, crisis |
| 10 | <span class="rune-glyph">ᚾ</span> | Nauthiz | Need, constraint, necessity |
| 11 | <span class="rune-glyph">ᛁ</span> | Isa | Ice, stillness, stasis |
| 12 | <span class="rune-glyph">ᛃ</span> | Jera | Year, harvest, cycle |
| 13 | <span class="rune-glyph">ᛇ</span> | Eihwaz | Yew, endurance, the world axis |
| 14 | <span class="rune-glyph">ᛈ</span> | Perthro | Lot-cup, fate, the hidden |
| 15 | <span class="rune-glyph">ᛉ</span> | Algiz | Elk-sedge, protection, reaching |
| 16 | <span class="rune-glyph">ᛊ</span> | Sowilo | Sun, victory, the will to succeed |

<details>
<summary><strong>DC 15 Intelligence (Arcana) — Recalling what each of Hagal's Aett does when carved</strong></summary>

- **Hagalaz:** Carved on a surface and activated: 10-foot radius of difficult terrain (hailstones or ice, depending on climate) for 1 hour.
- **Nauthiz:** Carved on a binding or cord: a creature bound by it has disadvantage on Strength checks to escape; the binding cannot be cut by mundane blades.
- **Isa:** Carved on a body of water or liquid: freezes up to 10 cubic feet of the liquid solid for 1 hour.
- **Jera:** Carved on a crop field or stored grain: the food does not spoil for one month.
- **Eihwaz:** Carved on a bow: the bow's arrows never deviate from wind; ignore cover from terrain features (though not from creatures).
- **Perthro:** Carved on dice or any object used for divination: the next reading is accurate without a check required.
- **Algiz:** Carved on armor or a shield: once per short rest, the wearer can impose disadvantage on one attack roll against them as a reaction.
- **Sowilo:** Carved on a weapon: the weapon counts as silvered; creatures that are specifically vulnerable to sunlight have disadvantage on saves against its damage.
...
| # | Rune | Name | Meaning |
|---|---|---|---|
| 17 | <span class="rune-glyph">ᛏ</span> | Tiwaz | Tyr, justice, lawful victory |
| 18 | <span class="rune-glyph">ᛒ</span> | Berkano | Birch, growth, new beginnings |
| 19 | <span class="rune-glyph">ᛖ</span> | Ehwaz | Horse, partnership, swift movement |
| 20 | <span class="rune-glyph">ᛗ</span> | Mannaz | Mankind, community, the self |
| 21 | <span class="rune-glyph">ᛚ</span> | Laguz | Lake, flow, the depths |
| 22 | <span class="rune-glyph">ᛜ</span> | Ingwaz | Ing, completion, contained power |
| 23 | <span class="rune-glyph">ᛞ</span> | Dagaz | Day, breakthrough, transformation |
| 24 | <span class="rune-glyph">ᛟ</span> | Othala | Ancestral land, inheritance, belonging |

<details>
<summary><strong>DC 15 Intelligence (Arcana) — Recalling what each of Tyr's Aett does when carved</strong></summary>

- **Tiwaz:** Carved on a weapon used in a just cause: +1 to attack rolls; the attack deals an extra 1d6 radiant damage against creatures that have broken an oath or committed treachery.
- **Berkano:** Carved on a wound or applied to a sick person: the next Medicine check to stabilize or treat the person has advantage.
- **Ehwaz:** Carved on two objects: their bearers can communicate telepathically within 30 feet.
- **Mannaz:** Carved on a threshold: the carver knows the number and nature of creatures inside.
- **Laguz:** Carved on a boat or near water: the carved vessel cannot be capsized by natural means for 24 hours.
- **Ingwaz:** Carved on a camp perimeter: creatures sleeping inside cannot be surprised; the perimeter lights up briefly if crossed.
- **Dagaz:** Carved on a sealed door: the door opens silently for the carver once; the carving then fades.
- **Othala:** Carved on a dwelling: the family or group it is carved for cannot be driven from it by fear effects.
...
## Spelling variants elsewhere in this book
A few existing props transliterate two of these names slightly differently — *Naudhiz*
for Nauthiz, *Othalan* for Othala. Both are attested real-world spellings and neither is
wrong, but this table is the canonical spelling going forward for anything new.
:::
