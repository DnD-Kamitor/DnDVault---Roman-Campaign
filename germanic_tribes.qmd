...
**DM note:** The Alaisiagae can serve as a dark mirror to the party's relationship with Mars. Where the cult of Mars demands sacrifice and control, the Alaisiagae demand loyalty and justice. A Germanic soldier PC may invoke them instead of Mars, with different consequences.
...
|---|---|---|---|---|
| 1 | ᚠ | Fehu | Cattle, wealth, mobile property | Carved on a coin purse or trade goods: +2 to Persuasion checks involving commerce for the session |
| 2 | ᚢ | Uruz | Aurochs, strength, raw force | Carved on a weapon: the weapon deals +2 damage on the first hit each combat |
| 3 | ᚦ | Thurisaz | Giant, thorn, directed force | Carved on a gate or barrier: creatures attempting to force it through must make DC 14 Strength check |
| 4 | ᚨ | Ansuz | Aesir, breath, divine communication | Carved on a message or object: the intended recipient recognizes it as meant for them across any distance; they sense the sender's identity |
| 5 | ᚱ | Raidho | Ride, journey, the right path | Carved on a wagon or boot: travel by this route takes half the expected time once per journey |
| 6 | ᚲ | Kenaz | Torch, opening, knowledge | Carved on a door or seal: the carver knows if the sealed item has been opened or disturbed |
| 7 | ᚷ | Gebo | Gift, exchange, balance | Carved on two objects of equal value: the exchange is witnessed by the gods; breaking the agreement incurs divine displeasure (-1d4 to all rolls for 24 hours) |
| 8 | ᚹ | Wunjo | Joy, harmony, wish | Carved on a dwelling or camp: creatures sleeping here recover one additional HD during a long rest |

#### Hagal's Aett (runes 9-16)

| # | Rune | Name | Meaning | Game effect when carved |
|---|---|---|---|---|
| 9 | ᚺ | Hagalaz | Hail, disruption, crisis | Carved on a surface and activated: 10-foot radius of difficult terrain (hailstones or ice, depending on climate) for 1 hour |
| 10 | ᚾ | Nauthiz | Need, constraint, necessity | Carved on a binding or cord: a creature bound by it has disadvantage on Strength checks to escape; the binding cannot be cut by mundane blades |
| 11 | ᛁ | Isa | Ice, stillness, stasis | Carved on a body of water or liquid: freezes up to 10 cubic feet of the liquid solid for 1 hour |
| 12 | ᛃ | Jera | Year, harvest, cycle | Carved on a crop field or stored grain: the food does not spoil for one month |
| 13 | ᛇ | Eihwaz | Yew, endurance, the world axis | Carved on a bow: the bow's arrows never deviate from wind; ignore cover from terrain features (though not from creatures) |
| 14 | ᛈ | Perthro | Lot-cup, fate, the hidden | Carved on dice or any object used for divination: the next reading is accurate without a check required |
| 15 | ᛉ | Algiz | Elk-sedge, protection, reaching | Carved on armor or a shield: once per short rest, the wearer can impose disadvantage on one attack roll against them as a reaction |
| 16 | ᛊ | Sowilo | Sun, victory, the will to succeed | Carved on a weapon: the weapon counts as silvered; creatures that are specifically vulnerable to sunlight have disadvantage on saves against its damage |

#### Tyr's Aett (runes 17-24)

| # | Rune | Name | Meaning | Game effect when carved |
|---|---|---|---|---|
| 17 | ᛏ | Tiwaz | Tyr, justice, lawful victory | Carved on a weapon used in a just cause: +1 to attack rolls; the attack deals an extra 1d6 radiant damage against creatures that have broken an oath or committed treachery |
| 18 | ᛒ | Berkano | Birch, growth, new beginnings | Carved on a wound or applied to a sick person: the next Medicine check to stabilize or treat the person has advantage |
| 19 | ᛖ | Ehwaz | Horse, partnership, swift movement | Carved on two objects: their bearers can communicate telepathically within 30 feet |
| 20 | ᛗ | Mannaz | Mankind, community, the self | Carved on a threshold: the carver knows the number and nature of creatures inside |
| 21 | ᛚ | Laguz | Lake, flow, the depths | Carved on a boat or near water: the carved vessel cannot be capsized by natural means for 24 hours |
| 22 | ᛜ | Ingwaz | Ing, completion, contained power | Carved on a camp perimeter: creatures sleeping inside cannot be surprised; the perimeter lights up briefly if crossed |
| 23 | ᛞ | Dagaz | Day, breakthrough, transformation | Carved on a sealed door: the door opens silently for the carver once; the carving then fades |
| 24 | ᛟ | Othala | Ancestral land, inheritance, belonging | Carved on a dwelling: the family or group it is carved for cannot be driven from it by fear effects |
