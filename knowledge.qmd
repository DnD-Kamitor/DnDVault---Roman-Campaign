...
- **Survival proficiency** — Water sources by terrain type; the two-hour warning sign of incoming weather on the frontier (cloud formation over the hills before the pressure drop); which animals indicate safe foraging ground and which mean stay away; how far a column can march before horses need water (every four hours of march) versus men (every six hours under moderate load).
- **Athletics proficiency** — How long a soldier can run in full kit before becoming combat-ineffective (roughly 400 yards at combat pace); the maximum load a soldier can carry for 20 miles without degrading performance the next day (standard kit is 80 lbs, hard limit is 110 lbs before injury accumulates); how to identify a man whose legs are about to fail before he falls out of formation.
- **Animal Handling proficiency** — The signs of a horse about to throw its rider; how to calm a pack animal spooked by combat noise; the difference between a horse that is tired and a horse that is injured in a way that will worsen with continued movement.
- **Constitution 14+** — You know your own physical limits exactly: how much cold you can absorb before your hands stop working reliably, how many hours without sleep before your threat assessment becomes unreliable, the exact moment when you shift from tired to dangerous to yourself and others. You use this to manage your margin in the field, and you can read the same limits in the soldiers around you.
...
- **Intimidation proficiency** — The specific display behaviors that Roman military authority uses: the parade-ground voice that carries without shouting; the body language of a soldier who has given the last warning; the difference between Germanic warriors who are testing your resolve (they respond to escalation) and those who are committed to contact (escalation makes it worse, not better).
- **Persuasion proficiency** — The social hierarchy of the frontier and who can authorize what: what a decurion can authorize, what requires a centurion, what requires the Legate; how to frame a request to avoid triggering rank-protectionism; which NPCs in the fort respond to military formality and which respond to direct personal appeal.
- **Performance proficiency** — Military ceremony functions as battlefield Intimidation at scale. The *testudo* formation is not only a tactic; it is a performance. A unit that moves with military precision has advantage on group Intimidation checks against opponents who understand what they are seeing. Germanic warriors specifically recognize Roman formation discipline, and some will break before contact if it is displayed correctly and consistently.
...
- **Military Lore proficiency** — You know Belatucadrus as a common soldier's name for Mars in Britain. His shrine at Luguvalium on the western Wall is visited by legionaries before long marches north.
...
- **Dexterity 14+** — You read spatial geometry without thinking about it. You know where you are in a room in darkness, which exits are where, what the nearest cover is from any position. You have never been surprised by a door.
