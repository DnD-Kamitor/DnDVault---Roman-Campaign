...
<details>
<summary>**GM Reference: Cross-Reference Skill Unlocks** *(click to expand)*</summary>

Three knowledge check results unlock skill checks in play that would not otherwise exist. These are documented here for DM reference.

**Military Lore DC 17 → ruins Investigation check:**

The DC 17 result for Roman Military Lore reveals that legion numbers XVII, XVIII, and XIX are permanently retired. A character with this result who later encounters equipment in the ruins beneath Vindolanda (Room 3, Gallery of Echoes, or the Vault) can attempt a DC 15 Investigation to check the legion markings on the armor. If they succeed: the armor is marked with Legion XVII. A legion that should not exist here. This opens the question: who brought this equipment, and when?

This check does not exist for characters without the DC 17 military knowledge result. The equipment marking is there; knowing it matters requires the context.

**Germanic Tribes DC 15 → Vercingetorix approach DC:**

A character who succeeds at DC 15 Germanic Tribes (the tribal political structure, the *comitatus*, and the wergild system) does not need to be briefed on basic Germanic honor codes before meeting Vercingetorix. They know not to offer Roman status as a concession (he does not care about Roman status), and they know that acknowledging his people's claim before asking for anything is the correct opening move.

Mechanical effect: the first Persuasion check with Vercingetorix is at DC 12 instead of DC 15 for characters with this knowledge. They do not insult him in the first minute, which is where most Romans lose the conversation before it starts.

**Divine Signs DC 17 → Session 4 augury interpretation:**

The DC 17 result for Divine Signs (omens, the specific warnings of the twelve failed sacrifices, what specific sign categories precede divine manifestation) gives a character the context to understand Paterculus's Session 4 observations in a way Paterculus himself cannot fully articulate.

When Paterculus shares his written omen document in Session 4, a character with DC 17 Divine Signs can interpret it correctly at DC 13 Religion (instead of DC 17 without the context). More importantly: they can answer one question Paterculus has been unable to answer -- why the morning sacrifice failure sequence is accelerating. The answer is that the sacrifice is failing faster because the divine presence it is meant to acknowledge is getting closer, not because something is wrong with the ritual. This shifts the party's understanding of Mars' arrival from "catastrophe" to "scheduled event that has always been coming."
...
<details>
<summary><strong>DC 13 — What any soldier on the Germanic frontier knows</strong></summary>
...
<details>
<summary><strong>DC 15 — What a veteran, haruspex-trained soldier, or frontier officer knows</strong></summary>
...
<details>
<summary><strong>DC 17 — What a senior haruspex, temple priest, or Marcus-Aurelius-era religious scholar knows</strong></summary>

The *ancilia* tradition: twelve sacred shields are kept in the Regia in Rome, said to have fallen from heaven during the reign of Numa Pompilius. The priesthood of the Salii (leaping priests) is responsible for their care. The tradition holds that eleven of the twelve are copies, created to confuse anyone who tried to steal the original. The original has specific properties the copies do not. The properties are not documented in public texts; they are passed orally between Salii priests.

A minority scholarly tradition holds that there are not twelve ancilia but thirteen: the twelfth is the public count, the thirteenth is hidden because its existence is destabilizing. A divine weapon in the wrong hands does not simply make the holder powerful; it makes them the god's agent, with the god's agenda, not their own. The religious danger of the spear in the vault is not corruption in the corruption-mechanic sense; it is specifically the risk of becoming a vessel for a divine agenda the holder has not consented to.

The phrase *"Mars hears the loudest heart"* appears in three separate locations across the campaign (the inscription in the Sunken Armory, a line in Paterculus's omen documentation, and a phrase Cassia says under her breath in Session 4). This is not coincidence. The phrase is from an old Mars cult formula that predates the Republic. It means that Mars responds not to volume of prayer but to sincerity of intent. A soldier who is genuinely ready to die for their cause is heard more clearly than a hundred soldiers saying the correct words.
...
<details>
<summary><strong>DC 13 — What any soldier who has been here long enough to notice knows</strong></summary>
...
<details>
<summary><strong>DC 15 — What a soldier with Religion training or extensive frontier posting knows</strong></summary>
...
<details>
<summary><strong>DC 17 — What a scholar of pre-Roman religion, a specialist *haruspex*, or Cassia knows</strong></summary>

The Vindolanda spring's *genius loci* is not the same spirit as the one that guards the ruins below. They are distinct entities that have been in the same location for different amounts of time. The *genius loci* of the spring predates the Germanic temple below by what religious scholars estimate as four to six centuries. It predates Rome's presence in this region by even longer.

The spring spirit's religion of origin is not Roman and not Germanic. The closest surviving tradition is Gallic, but even that is not exact. The spirit does not have a name in any of the three available reference traditions; Thusnelda knows it exists and calls it *"the old one under the water"* in her language, which is translation, not naming.

The spring spirit and the spear are in a quiet antagonism. The spirit has been suppressing the spear's influence within its range since the excavation disturbed the temple below and brought the spear into the same vertical column of ground. This is why corruption dreams have been less frequent in the northeast barracks. It is also why the spear's influence has been concentrated toward the west of the fort, where the *genius loci* has no reach. A character who understands this can use the northeast barracks as a refuge from corruption pressure, and can offer the *genius loci* something in exchange for temporarily extending its protection to the party during a specific critical moment.
...
<details>
<summary><strong>DC 13 — What a frontier soldier picks up from experience and observation</strong></summary>
...
<details>
<summary><strong>DC 15 — What a scholar of the frontier, an explorator, or a soldier with years of contact knows</strong></summary>
...
<details>
<summary><strong>DC 17 — What a scholar of pre-Roman northern European religion knows (rare; Thusnelda knows more)</strong></summary>

The *seiðr* tradition (the form of magic Thusnelda practices) is specifically a women's art in the dominant Germanic tradition. A man who performs *seiðr* is doing something that costs him social standing in ways the Romans find confusing: it is not simply stigmatized but categorized as a different kind of transgression involving the blurring of social role rather than moral violation. This context explains aspects of Thusnelda's authority that Roman soldiers find puzzling.

The standing stones of the sacred grove are a form of long-term *seiðr* working: the runes were placed in specific patterns to create a sustained effect over decades. The effect is not a spell in the D&D sense (it cannot be dispelled) but a permanent negotiated arrangement with the land itself. The grove does not have a *genius loci* in the Roman sense; it has a *collective memory* contributed to by every ritual performed in it, stretching back to the pre-Germanic people who placed the stones originally.

The spear in the vault and the grove are connected by the original sealing oath. The grove does not destroy the spear directly; it provides the context in which the spear can be released back to its divine owner without residual effect. Without the grove, the spear can be broken physically, but the divine attention it carries does not dissipate -- it attaches to whoever broke it. This is why Thusnelda insists on the full ritual: not because the spear must be destroyed but because it must be *released correctly*.
...
<details>
<summary><strong>DC 13 — What any frontier soldier knows from experience and warnings</strong></summary>
...
<details>
<summary><strong>DC 15 — What a Medicus, herbalist, or dedicated field forager knows</strong></summary>
...
<details>
<summary><strong>DC 17 — What a specialist botanist, a völva, or a very experienced herbalist knows</strong></summary>

*Wolfsbane and corruption:* In very specific preparation (dried root powder, mixed with spring water from an active spring *genius loci*, applied topically rather than ingested), wolfsbane suppresses the physical symptoms of corruption by 24 hours per dose. The preparation requires a DC 16 Medicine check and the presence of active spring water (the sealed Vindolanda spring water counts if the seal has been acknowledged). The character does not recover corruption levels; the external symptoms simply stop advancing for 24 hours. This is not documented in any Roman text; it is Thusnelda's traditional knowledge that she shares only with someone she trusts.

*Elder and the dead:* The specific elder tree near the fort's south gate has been growing for approximately eighty years. The *genius* of this particular tree has accumulated enough history to serve as a record of significant events in its vicinity. A character with DC 17 Nature who spends one full hour sitting with the tree and does not speak can roll DC 15 Wisdom to receive one impression from the tree's accumulated memory -- not words, not images, but *feeling-knowledge*: who was in significant emotional distress near this tree, and approximately when. The character cannot choose what impression they receive.

*The marsh orchid:* Grows in the bog region, rare, identifiable by its purple spotted leaves. Medicinally inactive in standard use. Ritually: the root of the marsh orchid is used in the Mithraic seven-grade initiation rite at two specific stages. A character who knows both the orchid and the Mithras cult (DC 17 Religion) can deduce from the presence of cultivated marsh orchids at a specific location that a Mithraic initiations took place there recently. This is how to find the Mithraic chapel in the bathhouse annex without an informant: the orchid root traces in the drainage.
...
<details>
<summary><strong>DC 13 — What a curious soldier picks up from observation and asking around</strong></summary>
...
<details>
<summary><strong>DC 15 — What a scholarly soldier, a long-serving veteran, or an investigating character discovers</strong></summary>
...
<details>
<summary><strong>DC 17 — What a specialist in pre-Roman northern European archaeology or a very experienced religious investigator discovers</strong></summary>

The circular structure predating the Germanic settlement is consistent with a construction tradition that modern scholars would associate with Iron Age Gallic or pre-Gallic peoples, but the construction shows no Celtic decorative elements. The closest parallel is found in a handful of structures in what will eventually be called Scandinavia, in regions where Roman archaeology does not reach. This structure is from a people who were here before the tribes who replaced them.

The alignment of the structure (midwinter sunrise entrance, midsummer sunset exit) creates a specific effect on the winter solstice: the sunrise at midwinter shines directly through the entrance, along the central axis, and out the exit, for approximately three minutes. During those three minutes, a person standing at the center of the structure (now below the granary floor) would be illuminated by direct sunlight. The practical significance of this is unknown. The religious significance is considerable to anyone who understands solstice alignment traditions.

The spring is at the center of this alignment. The pre-Roman people sealed the spring themselves; the stone cap that the Roman engineers used is a Roman stone laid on top of an older, better-fitted stone cap in a different material. Someone sealed this spring before Rome arrived, and the Romans sealed it again without knowing it had already been sealed. What is in the spring is not dangerous. What is in the spring has been there, sealed, for a very long time, and has been sealed for a purpose. A character who performs the acknowledgment rite for the *genius loci* and specifically asks what is sealed beneath -- DC 16 Religion, requiring prior DC 17 History to know to ask -- receives one answer: *"Not for long."*
