...
Live backlog tracking now happens in `SCRUM_BACKLOG.md` (Epics + INVEST stories). Only
remaining open item there: **Epic 5, Sessions 1-2 Improvement Pass** — lower priority,
since both sessions already had a dedicated improvement milestone (21, 22). Add new
epics there as they come up rather than in this section.
