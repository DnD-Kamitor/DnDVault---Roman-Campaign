...
**Partial success reframes for existing crisis checks:**

*Gate breach -- DC 14 Athletics to hold the ram:*
- 5 below: The gate holds for two rounds instead of three. One additional soldier is taken down before engineers arrive.
- Exact: Gate holds the full three rounds; engineers get the beams wedged.
- 5 above: Gate holds AND the party sees the ram-crew commander -- a Germanic warrior with a specific war-charm on his belt (amber, carved with *TIWAZ*). This is information for Sigrun later: a specific chieftain's people, not the united warband.

*Granary fire -- DC 15 Survival:*
- 5 below: Fire controlled but rations reduced by 1d6 (partial success: save what you can).
- Exact: Fire stopped. Full ration stock preserved.
- 5 above: Fire stopped early enough to salvage the grain AND to find the slow-burn candle setup (see locations.qmd skill menu). The arson method is now in evidence.

*Shrine desecration -- DC 14 Insight to notice the agent:*
- 5 below: You notice something wrong 1 round after the agent begins. Contested Dex instead of auto-notice.
- Exact: You notice as he starts. Contested Dex as written.
- 5 above: You notice AND you see that he is deliberately avoiding the threshold rune Paterculus placed -- he knows the ward system. He has been briefed.

**Cascade unlock: the soldier who held the wall:**

If Flavus was named in Session 2 (the cascade from DC 17 there), he appears here as an escort volunteer. He does not need to be recruited; he recruits himself. If he was not named: recruit Varro's recommendation instead (no cascade, but Varro's endorsement carries weight).

**New temporal gate: Mars' arrival read (Session 4, Scene 3 tunnel sequence):**

When the party descends into the tunnels with the spear, the first character to carry the spear through the Elder Stair (Room 3 equivalent below) has one opportunity:

- *DC 13 Insight, one round only:* The spear's weight shifts toward the altar chamber before they can see it. The direction is specific and consistent. This tells the character that the spear knows where it is going and has been here before.
- *What it opens:* In the antechamber (Scene 4), this character has advantage on the first Persuasion check with Mars if they mention this observation. "The spear remembers this place" is an argument Mars finds interesting; it shows the character was paying attention to what the divine object was telling them rather than just carrying it.
- *Miss the window:* The knowledge is lost once they enter the antechamber; the shift stops when the spear can "see" the altar directly.

**Partial success: the three kneeling figures demand (Scene 4, antechamber):**

Currently binary: three kneel or Mars adds extra trials. Add partial success:

- *One volunteer:* Mars allows it but notes the insufficiency. The trials in Session 5 begin with one additional consequence already in effect (he started disappointed).
- *Two volunteers:* Mars accepts with reservations. Session 5 begins normally.
- *Three volunteers with the correct composition (one Roman, one Germanic, one spear-touched):* Mars is satisfied. One trial in Session 5 is reduced in difficulty by one tier (DM's choice which).
