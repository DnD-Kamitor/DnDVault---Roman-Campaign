...
## Handout 15: Marcomanni Vision — The Boar's Last Field

::: {.handout-meta}
- **When to give:** Session 1, Scene 2. First character touches any boar-shield in the Shield Hall.
- **How to present:** Hand it face-down without comment. Let the player flip it and read in silence. They share it if they choose.
:::

::: {.handout-card}
**THE BOAR'S LAST FIELD**

*[A vision: the warrior who hung this shield. You see through his eyes.]*

I carried the boar through eleven winters. My sons learned to hold a spear before they could hold a plough. The Romans said we would be partners. Then the borders moved. Then the tribute doubled. Then the army came.

They burned the village behind us so we would know what surrendering meant. My eldest is in a Roman arena now. I do not know if he is alive.

I hung this shield here so Mars would remember our name when Rome has finished forgetting it.

My name is Widukind. My sons are named Adalbert and Gerlach. I want someone to know that.

Rome calls this the Marcomannic War. We call it what happens when you trust a treaty.

*[Vision ends. The shield is heavier than it was.]*
:::

**What it reveals:** The Marcomanni war is happening right now, in 175 AD. Someone who hung a shield here recently — within the last five years — is a contemporary of the party's own lifetime. The vault is not ancient history. It is current events.


## Handout 16: Cherusci Vision — Three Fingers

::: {.handout-meta}
- **When to give:** Session 1, Scene 2. First character touches any three-fingered-hand shield.
- **How to present:** As Handout 15 — face-down, silent, player decides when to share.
:::

::: {.handout-card}
**THREE FINGERS**

*[A vision. You stand in the forest. The year is 9 AD. You are someone else.]*

Three fingers. Three Roman legions. We buried them in the Teutoburg forest the year Romans call nine. We thought that was the end of it.

Germanicus came back seven years later with fire. He burned every longhouse between the Rhine and the Weser. He dug up his own dead to give them Roman funerals. He called us pacified.

My grandfather hung this shield here after Arminius died. Murdered by his own family — Rome does not always need soldiers. They offered gold to his brother. Let us do the rest.

The three fingers mean: we remember the legions we destroyed. We also remember what it cost us.

The Cherusci do not exist anymore. Not as a people. There are men with Cherusci blood, scattered, calling themselves Roman names.

That is what three fingers cost us.

*[Vision ends. Somewhere in the dark, the torchlight dims.]*
:::

**What it reveals:** Arminius is a name every Germanic character knows. Ursula knows it. The three fingers are the Teutoburg legions — a Germanic victory that Rome spent a generation punishing. The Cherusci are gone. This vault outlasted them.


## Handout 17: Suebi Vision — The Serpent Does Not Stop

::: {.handout-meta}
- **When to give:** Session 1, Scene 2. First character touches any serpent-shield.
- **How to present:** As above.
:::

::: {.handout-card}
**THE SERPENT DOES NOT STOP**

*[A vision. The warrior is older than the others. She has been here before.]*

The serpent never stops moving. That is why we chose it. You cannot hold a serpent still.

Rome built walls. We went around. Rome made treaties. We signed them and kept moving. Rome sent legions. We dispersed and came back. We are not a tribe: we are a current of people who refuse to be still.

We brought this shield here because even a moving people need somewhere to remember. The serpent coils here while the people move. When you need to find us, look for the place where we left something standing still.

Some of our children signed their names as Romans. That is fine. They are still moving. The name does not matter. The motion does.

We will still be here when the walls fall.

*[Vision ends. The torchflame leans toward the far archway, as if agreeing.]*
:::

**What it reveals:** The Suebi were never destroyed — only divided, scattered, renamed. This is the most hopeful of the four visions. A character who notices this will understand: the Suebi gave Rome the least because they feared it least. They were here and are still here. The motion continues.


## Handout 18: The Nine — Unnamed

::: {.handout-meta}
- **When to give:** Session 1, Scene 2. A character specifically examines the nine smallest, unmarked shields.
- **How to present:** Slide it to whoever looked. Pause. If anyone asks who these people were: "Nobody knows. Not even Rome."
:::

::: {.handout-card}
**NAUDHIZ — WE NEEDED**

*[No vision. Only words, scratched into the stone behind these shields.]*

Nine of us came. One family. We had no tribe anymore; Rome had taken the name from us before we understood what that meant.

We brought nine shields. One each. We asked Mars to remember us since no one else would. We did not ask for victory. We did not ask for justice. We asked to be remembered.

There is no record of us in Roman archives. We checked, later, when some of us learned Latin. The Romans erased us so completely that even the account of our erasure is gone.

NAUDHIZ. Need. We were in need.

We came here once. We left nine shields. We did not come back.

If you are reading this, Mars kept his word. We exist here, in this stone, on these shields, and now in your memory.
...
**What it reveals:** This is the vault's most devastating detail. A people so thoroughly erased that no name survives. Not even a tribal name. Just nine shields, a need that was never answered, and the hope that someone would eventually stand where you are standing. Give the players a moment.
