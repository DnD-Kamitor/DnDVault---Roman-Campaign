...
**In the Campaign:** A strix nest near a military fort explains the unaccountable deaths of sentries (see Chapter 2 hooks). A cult of Mars might keep striges as consecrated hunters, releasing them against enemies. A single strix following the party could be a divine message — Mars uses many messengers — or simply a predator drawn to blood.
...
|---|---|---|
| Strix | Blood; cannot be propitiated — only repelled by light | — |
...
| Lindworm | Cannot be propitiated — only fought, fled, or trapped | — |
