...
**Note on the Optio:** The Optio's *hastile optioni* (knobbed staff) functions identically mechanically but is visually distinct. An Optio seen carrying a *vitis* will be asked directly who gave it to them.
...
| *Vitis* | Simple | 1d6 bludgeoning | Light, authority property (Roman soldiers only) | 2 lb | 2 sp |
