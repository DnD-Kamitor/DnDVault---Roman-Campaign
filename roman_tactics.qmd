...
The sling is a staff-sling or hand-sling used by auxiliary *funditores*. Deceptively simple, it fires three distinct ammunition types at different ranges, each with a different purpose. A trained *funditor* can fire one shot per round without needing to load as a separate action unless noted. The sling itself is a Simple weapon, costs 2 gp, weighs 1/4 lb.

**Using a sling in close formation:** Attacks with a sling while in a formation where allies are within 5 feet are made at disadvantage. The weapon needs swing room.
...
The heavy *pilum* is the standard Roman throwing spear, designed specifically to defeat shields and deny return fire. The shank below the iron head is intentionally soft: it bends on penetrating a shield, making removal impossible and the shield unusable until repaired.

Heavy *pilum*: Martial weapon. Thrown (30/60 ft). 1d8 piercing. On a hit, the target's shield is unusable until repaired (1 hour of work with appropriate tools). The pilum cannot be thrown back by the target. Retrieving a heavy pilum from the battlefield requires a DC 14 Athletics check as a bonus action after combat ends (most are bent beyond use). Cost: 5 sp. Weight: 4 lb.

#### Light *Pilum*

The lighter variant is used for closer engagements and by auxiliary units. It does not bend on impact, which means it can be retrieved and reused, but it also means it can be thrown back.

Light *pilum*: Martial weapon. Thrown (20/40 ft). 1d6 piercing. Deals +1d4 piercing damage on the first attack in any combat against a target that is not currently carrying a shield (the lighter head reaches the body more directly without shield deflection). Can be retrieved freely after combat. Cost: 3 sp. Weight: 2 lb.
...
The legionary's primary sidearm. Short enough to use in tight formation, double-edged for cutting, and pointed for thrusting into gaps in armor. Its design rewards the press of bodies rather than fighting it.
...
The longer sword favored by cavalry and Germanic auxiliary units. Requires space to swing effectively.
...
Standard issue alongside the *gladius*. Used as a backup weapon, a tool, and in close-quarters situations where the gladius cannot be drawn. The short blade provides advantage when the fight goes to grappling.
...
The thrusting spear of the heavy infantry, used from behind a shield wall and set against cavalry charges. Longer than the *gladius* but slower to bring to bear in a clinch.

*Hasta*: Martial weapon. 1d8 piercing, reach, two-handed. Brace: if you have not moved during your turn, you can set the *hasta* against an incoming charge. Any creature that moves into your reach during that round triggers an opportunity attack from you; this opportunity attack deals double damage on a hit. Cost: 2 gp. Weight: 6 lb.

#### *Dolabra* (Military Pick/Axe)

The legionary's combination entrenching tool and battlefield weapon. Every soldier carries one. In combat it functions as a pick; against structures and fieldworks, it is devastating.

*Dolabra*: Martial weapon. 1d8 piercing, two-handed. Against stone walls, wooden structures, earthwork fortifications, or constructed barriers: the *dolabra* deals double damage. A creature using stone cover (a low wall, a battlement, a fortified corner) does not benefit from that cover against a *dolabra* attack: the pick can dislodge the cover itself with a successful hit (the cover is destroyed on a second hit). Cost: 3 gp. Weight: 5 lb.
