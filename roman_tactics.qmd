...
- A ladder can be pushed back by 1 person making a DC 13 Strength (Athletics) check as an action
...
**Countering:** Scouts moving 100 feet ahead reduce the ambush success chance. DC 15 Wisdom (Perception) to detect the ambush before it springs.
...
- **Shieldbreaker Rule:** A Schildwall can be broken by a character who succeeds on a DC 15 Strength (Athletics) check to wedge a weapon between shields; this costs an action but removes the shield benefit from two adjacent defenders for one round
...
- The Kesselschlacht is broken if the party can eliminate the encircling forces' leader (DC 14 Wisdom (Perception) to identify them in the confusion)
...
**Vindolanda stock:** None standard. Available through eastern auxiliary units passing through, from traders in the *vicus* on DC 15 Intelligence (Investigation), or through Sigrun's network at Camp Level 2 or higher.
...
**Vindolanda stock:** Not standard issue. Available from eastern auxiliary traders through the *vicus* on DC 15 Intelligence (Investigation), or through Sigrun's network at Camp Level 2 or higher.
...
| **Creature identification** | Bonus action + DC 13 Intelligence (History) check to identify a creature from the Bestiary and recall its official classification and doctrine response |
...
**Requesting deployment (in-play):** Find Varro before the session's main action begins. He will ask one question: "Where are you going and what for?" Answer honestly or at disadvantage for social checks with him for the rest of the session. A DC 13 Charisma (Persuasion) check is required unless the party has Allied-tier relationship with him, in which case he approves without a roll.
...
**Legal limits:** Companions will not violate Roman military law regardless of orders. Specifically: they will not attack civilians who have not attacked first; they will not abandon the unit's standard in the field; they will not follow orders given by a character under obvious supernatural compulsion (corruption level 4 or higher creates visible signs; a soldier with 5+ years of frontier service can recognize them). A party member who attempts to order a violation may attempt DC 16 Charisma (Persuasion); failure locks out that soldier's cooperation for the session.
