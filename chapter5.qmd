...
**Temporal gate: Mars' arrival read (the first moment of the divine arena):**

When Mars rises from the throne at the start of the session, one character can notice something that others miss -- but only in the first round, before the party reacts.

- *DC 13 Insight, one round only:* Mars looks at one specific character first. The one who made the genuine grove sacrifice. His expression is not the same as the one he gives the others. It is not warmth -- it is recognition. He knows which one it was. He has known since the moment it happened.
- *What it opens:* That character has advantage on the first Option C argument if they open it by acknowledging the grove sacrifice. Mars respects that they paid attention to what he was watching.
- *Miss the window:* The moment passes when Mars speaks. After that, everyone gets the same read: impassive, god-sized, ready.

**Partial success reframes for Option C arguments:**

The three arguments that move Mars (and three that anger him) already exist. Add the 5-below/exact/5-above structure:

*A persuasive argument that lands (one of the three valid forms):*
- 5 below DC 19: He listens. He does not yield. He says: *"Say it again, differently."* The DC becomes 17 for the second attempt.
- DC 19 exact: He adjusts one term of the trial. The outcome range expands by one option.
- DC 24: He concedes the argument AND explains why. One sentence that only a god who has been watching since the grove ritual could say. Use the session 0 character material: he references something specific about that character that no one told him.

*An argument that angers him (one of the three invalid forms):*
- 5 below the anger threshold: He says *"Try again. That was wrong."* The attempt fails but the trial continues.
- Meeting the anger threshold: The trial advances to the next difficulty stage.
- 5 above (catastrophically wrong): The trial advances AND he adds a visual demonstration of displeasure (the black sand rises, the temperature drops, the absent crowd noise becomes present as a distant roar of dead soldiers).

**Cascade unlock: the failure recovery path (demonstration DC 14):**

If the party attempts Option C and fails badly (not "angers him" bad, but "genuinely no one can make a case" bad), there is one recovery:

- Any character who has the *Virtus* virtue from the virtue mechanic can invoke it here. They do not make an argument. They demonstrate. They step into the fighting circle that has been implied since Mars arrived, hold their ground without a weapon, and wait.
- DC 14 Wisdom save to hold still without flinching. On success: Mars stops. Looks at them for a long moment. Then says: *"That. That is what I asked for."* The trial terms reset to neutral; the argument option is available again.
- On failure: They flinch. Mars says nothing. The trial continues at normal parameters.

**Post-trial check: what Varro would say:**

If Varro survived and is present at the epilogue, and if the party asks him directly what he thinks of what happened:

- *DC 12 Insight to know he is holding something back.*
- *If asked what he is holding back:* He will say it. One sentence. It is different for every campaign and the DM writes it based on what actually happened. The structure is: *"I didn't expect you to [specific action from the session]. That surprised me. I'm hard to surprise."*
- This is not a mechanical reward. It is the last character moment of the campaign, handed to a player who paid attention to Varro across all five sessions.
