...
### Sessions 0 and 1 priority

- [ ] **Track A: handout_02** (vault inscription) — Stone inscription styling, Latin text of the contract scroll from the Binding Chamber, translation below. Essential for S1.
- [ ] **Track A: handout_03** (omens) — The augury Cassia performed before Session 1. Papyrus styling. Three omens read-aloud, DM interpretation. Essential for S1.
- [ ] **gm_session0.qmd audit** — Run a simulation of Session 0 using the same skeptical method as the S1 audit. Log gaps.
- [ ] **Em-dash sweep (S0+S1 files only)** — Prose em-dashes in gm_session0.qmd, session0.qmd, chapter1.qmd written before the style rule.
