...
| | |
|---|---|
| **Objective** | Keep the *taberna* standing, his network intact, and his debt to Wulfric resolved before the trader calls it |
| **Goal** | Maintain neutral standing with every faction in the fort so that whoever wins any given conflict still wants his bar open |
| **Agenda** | Collects specific information about every regular customer's debts, loyalties, and vulnerabilities; uses this as insurance rather than leverage, but the distinction is thin |
| **Secret** | The locked chest's false bottom contains a half-written letter to a contact in Carnuntum identifying Brutus's sleeper agent by name; Brennus figured it out three weeks ago when the agent overpaid for a room in a way that suggested someone else was covering his expenses; Brennus has not finished the letter because he has not decided what to do with it |
