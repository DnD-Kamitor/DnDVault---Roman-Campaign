...
Brennus wants the taberna standing and the debt to Wulfric gone before the trader decides to collect. Every move he makes serves those two goals. He is not neutral out of cowardice; he is neutral because the person who owes everyone a favor is never the first one burned.

His method: he knows what every regular customer owes, who they owe it to, and what they would do to keep it quiet. He holds this as insurance, not leverage. The distinction matters to him. It may not matter to the people he holds it on.

His secret: three weeks ago a man overpaid for a room. Not by much, but Brennus noticed. The kind of overpayment that happens when someone else is settling the bill and neither party wants a record. He pulled the thread. He now knows who Brutus's sleeper agent is by name. The half-finished letter to Carnuntum is in the false-bottom chest. He has not finished it because he has not decided if writing it makes things better or just makes him the next problem someone needs to solve.
...
| | |
|---|---|
| **Objective** | Maintain the relay network through whatever comes, including the siege; the network is her purpose and she treats its preservation as her primary responsibility |
| **Goal** | Get a specific letter to Eboracum without it passing through the official courier system; this letter names Brutus's primary Carnuntum contact and is the result of fifteen years of mail-pattern observation |
| **Agenda** | Evaluates every party interaction against whether it helps or threatens the relay; will share information in exchange for carrying duties; will not take sides officially but has already chosen a side in practice |
| **Secret** | She knows which messages went to Brutus's household from inside the fort; she has the addresses memorized and can name the specific officers who used her relay for correspondence they did not want in the military record; she has been holding this information for the right moment, which she believes is now |
...
| | |
|---|---|
| **Objective** | Understand what is happening with the spear and the ruins, because whatever it is will determine whether the *vicus* survives and whether his mother's family is in danger from the Germanic forces outside |
| **Goal** | Find out whether the party is making things better or worse, and position himself to help whichever outcome protects the people he is responsible for |
| **Agenda** | Does not commit until he has made his evaluation; runs what amount to informal reconnaissance missions on every faction in the fort without anyone's authorization; knows things he should not know from a fourteen-year-old with no official standing |
| **Secret** | His mother has been receiving messages from Vercingetorix's tribe through the south ditch gap Titus uses; he has been carrying them without knowing their content; the messages stopped three days before the siege began, which means someone on the Germanic side knew the siege was coming |
...
| | |
|---|---|
| **Objective** | Continue working at his trade through whatever comes; has no ambition beyond the quality of his repairs and the security of his workshop |
| **Goal** | Not be made to take a side, participate in a conflict, or leave the *vicus* under any circumstances |
| **Agenda** | Answers direct questions once per session from people who treat him respectfully; observes everything and records it in a set of personal notebooks he has been keeping for twenty years, written in a Gaulish dialect few people in this region can read |
| **Secret** | The notebooks document twenty-three years of observation at this frontier post: garrison rotations, supply irregularities, officer behavior, vicus activity, things that happened that were not recorded in any official document; he has not decided who, if anyone, the notebooks are for, but he has not destroyed them either |
